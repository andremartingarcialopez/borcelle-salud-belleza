...
export function AnaWilson() {
    return (
        <>
            <Header />
            <div className="lg:grid grid-cols-2 items-center mx-auto max-w-400 text-center lg:text-left gap-7">
                <div className="flex flex-col justify-center items-center w-full">
                    <img className="w-full" src="https://images.pexels.com/photos/11179580/pexels-photo-11179580.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="ana-wilson-img" />
                </div>

                <div className="px-1">
                    <h2 className="text-2xl md:text-4xl text-gray-600 font-semibold my-3">What is Borcelle?</h2>
                ...
                <div className="col-span-3 my-8 px-1">
                    <h2 className="text-2xl md:text-4xl text-gray-600 font-semibold mb-3">Ana Wilson – CEO of Borcelle</h2>
