      ...
      <div className="mx-auto max-w-[80rem] lg:grid grid-cols-2 gap-4 justify-center items-center p-2">
        <div>
          ...
          <div className="text-center lg:text-start">
            <h2 className=" text-2xl md:text-4xl font-bold text-[gray] my-3">Contact</h2>
            <h3 className="text-xl md:text-2xl font-semibold">Please fill out the form below to get in touch with us.</h3>
            <p className="md:text-xl my-2">At Borcelle, we’re committed to providing you with the best skincare experience. Whether you have questions about our products, need personalized skincare advice, or want to share your feedback, we’d love to hear from you. Our team is here to assist you on your journey to healthier, glowing skin.</p>
          </div>

          <div className="text-center lg:text-start ">
            <h3 className="text-xl md:text-2xl font-semibold">E-mail:</h3>
            <p className=" md:text-xl ">hello@rocelle.com</p>
          </div>
        ...
        <div>
          <form className="border-2 border-slate-300 p-10 rounded-xl flex flex-col w-full gap-3">
            ...
            <input type="submit" onClick={()=> sendForm()}  value={"Send"} className="w-full lg:w-40 mt-2 mb-5 border border-gray-500 py-2 px-6 text-center md:text-xl hover:cursor-pointer hover:bg-gray-300 hover:text-gray-500 rounded-2xl bg-gray-400 text-white font-bold"  />
          </form>
        </div>
      </div>
      <Footer/>
